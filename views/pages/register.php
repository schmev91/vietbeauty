            ...
            <div class="form__section">
                        ...
                        <form action="" class="form__section-form">
                            <div class="form-group">
                                <div class="form__container">
                                    ...
                                    <input type="text" id="firstName" class="firstName" name="firstName" placeholder="Nguyễn">
                                </div>

                                <div class="form__container">
                                    <label for="lastName">Tên <span class="red-text">*</span></label>
                                    <input type="text" id="lastName" class="lastName" name="lastName" placeholder="Văn A">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form__container">
                                    ...
                                    <input type="text" id="password" class="password" name="password" placeholder="Mật khẩu">
                                </div>

                                <div class="form__container">
                                    <label for="passwordcomfirm">Xác nhận mật khẩu <span class="red-text">*</span></label>
                                    <input type="text" id="passwordcomfirm" class="passwordcomfirm" name="passwordcomfirm" placeholder="Xác nhận mật khẩu">
                                </div>
                            </div>
                ...
                <div class="form__section-avatar">
                    <div class="form__section-avatar-content">
                        <img src="views/asset/img/user/icon.jpg.jpg" alt="">
                        <input type="file" class="upload-avatar" name="upload-avatar" id="upload-avatar" class="upload-avatar">
                        </input>
