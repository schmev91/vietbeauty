                    ...
                    <div class="form__section-form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form__container">
                                <label for="firstName">Họ <span class="red-text">*
                                        <?= isset($firstNameErr) ? '<span style="font-size: .6rem;color:red;" class="ms-1">' . $firstNameErr . '</span>' : '' ?>
                                    </span>
                            ...
                            <div class="form__container">
                                ...
                                <label for="lastName">Tên <span class="red-text">*
                                        <?= isset($lastNameErr) ? '<span style="font-size: .6rem;color:red;" class="ms-1">' . $lastNameErr . '</span>' : '' ?>
                                    </span></label>
                        ...
                        <div class="form__container">
                            <label for="username">Tên đăng nhập <span class="red-text">*</span>
                                <?= isset($usernameErr) ? '<span style="font-size: .7rem;color:red;" class="ms-1">' . $usernameErr . '</span>' : '' ?>
                            </label>
                        ...
                        <div class="form__container">
                            <label for="email">Email <span class="red-text">*</span>
                                <?= isset($emailErr) ? '<span style="font-size: .7rem;color:red;" class="ms-1">' . $emailErr . '</span>' : '' ?>
                            </label>
                        ...
                        <div class="form__container">
                            <label for="phone">Số điện thoại <span class="red-text">*</span>
                                <?= isset($phoneErr) ? '<span style="font-size: .7rem;color:red;" class="ms-1">' . $phoneErr . '</span>' : '' ?>
                            </label>
                        ...
                        <div class="form-group">
                            <div class="form__container">
                                <label for="password">Mật khẩu <span class="red-text">*</span>
                                    <?= isset($passwordErr) ? '<span style="font-size: .7rem;color:red;" class="ms-1">' . $passwordErr . '</span>' : '' ?>
                                </label>
                            ...
                            <div class="form__container">
                                <label for="passwordconfirm">Xác nhận mật khẩu <span class="red-text">*</span>
                                    <?= isset($passwordconfirmErr) ? '<span style="font-size: .7rem;color:red;" class="ms-1">' . $passwordconfirmErr . '</span>' : '' ?>
                                </label>
